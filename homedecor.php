...
<?php include('./header.php'); ?>
    ...
    <main class="main-content">
        ...
        <div class="container-withspace">
            <div class="categorie-name">HOME DECOR</div>
            <div class="content-container">
                    <?php
                   
                    $date=date("Y-m-d",time());
                    
                    $sql = "SELECT pname,price,image,time,type,ID,seller FROM product where type=4 and buyer =''and time >'".$date."' order by time desc;";
