...
<?php include 'connection.php';?>
    ...
    <main class="main-content">
        ...
        <div class="container-withspace">
            <div class="categorie-name">HOME APPLIANCES</div>
            <div class="content-container">
                    ...
                    $sql = "SELECT pname,price,image,time,type,ID,seller FROM product where type=3 and buyer =''and time >'".$date."' order by time desc;";
